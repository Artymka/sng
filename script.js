document.addEventListener("DOMContentLoaded", function (e) {
	...
	// План действий:
	// №1
	// при нажатии кнопки нужно генерировать опред. количество карточек с предсказаниями
	// далее создаём цикл, в котором с определённой частотой создаём новые элементы
	// и удаляем ушедшие за границу слайдера
	// каждый новый элемент будет за оперделённое время перемещаться за границу слайдера
	// в одну определённую точку
	// при нажатии кнопки остановки

	// №2
	// При нажатии кнопки нужно добавить опред. количество элементов в спец. контейнер.
	// Далее начать его двигать со определённой скоростью с помощью изменения свойства
	// left. Transition будет фиксированный, будет создан интервал, по которому контейнер
	// будет создавать внутри себя новые элементы и совершать перемещения. После нажатия
	// кнопки останова будет совершено конечное число итераций интервала
